...
extension Notification.Name {
        ...
        static let filterToTargetDidChange = Notification.Name("filterToTargetDidChange")
        static let targetBundleIDDidChange = Notification.Name("targetBundleIDDidChange")
